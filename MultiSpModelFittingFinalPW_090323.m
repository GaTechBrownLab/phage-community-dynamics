...
% Predict based off pairwise
% PA14 + AB + SA (with phage)
PA14_ABSA_YC = [ABSAp_CRKOYq AB_ABSA_CRKOYq SA_ABSA_CRKOYq]; 
BetaABSAPC = [b11_ABSAPC BetaABPC(1,2) BetaSAPC(1,2) rsave1(1,1);
    BetaABPC(2,1) BetaABPC(2,2) BetaABSA_pw(1,2) rsave1(1,2);
    BetaSAPC(2,1) BetaABSA_pw(2,1) BetaSAPC(2,2) rsave1(1,4)];
PA14_ABSA_YpredC = glv_simulation(tspan,PA14_ABSA_YC(1,:),BetaABSAPC);

% Calculate R-squared
r2_ABSAPC = Rsquare(PA14_ABSA_YC,PA14_ABSA_YpredC);

% Make density vs. time figure
%cfucurvefig(tspan,PA14_ABSA_Y,PA14_ABSA_Ypred,{'CRKO','AB','SA'},{'+ A. baumannii and S. aureus'})


% PA14 + BC + SA (with phage)
PA14_BCSA_YC = [BCSAp_CRKOYq BC_BCSA_CRKOYq SA_BCSA_CRKOYq]; 
BetaBCSAPC = [b11_BCSAPC BetaBCPC(1,2) BetaSAPC(1,2) rsave1(1,1);
    BetaBCPC(2,1) BetaBCPC(2,2) BetaBCSA_pw(1,2) rsave1(1,3);
    BetaSAPC(2,1) BetaBCSA_pw(2,1) BetaSAPC(2,2) rsave1(1,4)];
PA14_BCSA_YpredC = glv_simulation(tspan,PA14_BCSA_YC(1,:),BetaBCSAPC);

% Calculate R-squared
r2_BCSAPC = Rsquare(PA14_BCSA_YC,PA14_BCSA_YpredC);
...
BetaBCABPC = [b11_BCABPC BetaBCPC(1,2) BetaABPC(1,2) rsave1(1,1);
    BetaBCPC(2,1) BetaBCPC(2,2) BetaBCAB_pw(1,2) rsave1(1,3);
    BetaABPC(2,1) BetaBCAB_pw(2,1) BetaABPC(2,2) rsave1(1,2)];
PA14_BCAB_YpredC = glv_simulation(tspan,PA14_BCAB_YC(1,:),BetaBCABPC);

% Calculate R-squared
r2_BCABPC = Rsquare(PA14_BCAB_YC,PA14_BCAB_YpredC);

% Make density vs. time figure
%cfucurvefig(tspan,PA14_BCAB_Y,PA14_BCAB_Ypred,{'CRKO','BC','AB'},{'+ B. cenocepacia and A. baumannii'})
...
% no phage - for prediction, only pairwise data
b11 = mean([BetaAB(1,1),BetaBC(1,1),BetaSA(1,1)]);
b12 = BetaAB(1,2);
b13 = BetaBC(1,2);
b14 = BetaSA(1,2);

b21 = BetaAB(2,1);
b22 = mean([BetaAB(2,2),BetaBCAB_pw(2,2),BetaABSA_pw(1,1)]);
b23 = BetaBCAB_pw(2,1);
b24 = BetaABSA_pw(1,2);

b31 = BetaBC(2,1);
b32 = BetaBCAB_pw(1,2);
b33 = mean([BetaBC(2,2),BetaBCAB_pw(1,1),BetaBCSA_pw(1,1)]);
b34 = BetaBCSA_pw(1,2);

b41 = BetaSA(2,1);
b42 = BetaABSA_pw(2,1);
b43 = BetaBCSA_pw(2,1);
b44 = mean([BetaSA(2,2),BetaABSA_pw(2,2),BetaBCSA_pw(2,2)]);

% Predicted community interaction matrix, growth rates fixed from single species growth curves
...
b11P = mean([BetaABP(1,1),BetaBCP(1,1),BetaSAP(1,1)]);
b12P = BetaABP(1,2);
b13P = BetaBCP(1,2);
b14P = BetaSAP(1,2);

b21P = BetaABP(2,1);
b22P = mean([BetaABP(2,2),BetaBCAB_pw(2,2),BetaABSA_pw(1,1)]);
b23P = BetaBCAB_pw(2,1);
b24P = BetaABSA_pw(1,2);

b31P = BetaBCP(2,1);
b32P = BetaBCAB_pw(1,2);
b33P = mean([BetaBCP(2,2),BetaBCAB_pw(1,1),BetaBCSA_pw(1,1)]);
b34P = BetaBCSA_pw(1,2);

b41P = BetaSAP(2,1);
b42P = BetaABSA_pw(2,1);
b43P = BetaBCSA_pw(2,1);
b44P = mean([BetaSAP(2,2),BetaABSA_pw(2,2),BetaBCSA_pw(2,2)]);
...
% no phage - for prediction, only pairwise coeffs, 2 sp. data
b11 = mean([BetaABC(1,1),BetaBCC(1,1),BetaSAC(1,1)]);
b12 = BetaABC(1,2);
b13 = BetaBCC(1,2);
b14 = BetaSAC(1,2);

b21 = BetaABC(2,1);
b22 = mean([BetaABC(2,2),BetaBCAB_pw(2,2),BetaABSA_pw(1,1)]);
b23 = BetaBCAB_pw(2,1);
b24 = BetaABSA_pw(1,2);

b31 = BetaBCC(2,1);
b32 = BetaBCAB_pw(1,2);
b33 = mean([BetaBCC(2,2),BetaBCAB_pw(1,1),BetaBCSA_pw(1,1)]);
b34 = BetaBCSA_pw(1,2);

b41 = BetaSAC(2,1);
b42 = BetaABSA_pw(2,1);
b43 = BetaBCSA_pw(2,1);
b44 = mean([BetaSAC(2,2),BetaABSA_pw(2,2),BetaBCSA_pw(2,2)]);
...
% with phage - for prediction, only pairwise coeffs, 2 sp. data
b11P = mean([BetaABPC(1,1),BetaBCPC(1,1),BetaSAPC(1,1)]);
b12P = BetaABPC(1,2);
b13P = BetaBCPC(1,2);
b14P = BetaSAPC(1,2);

b21P = BetaABPC(2,1);
b22P = mean([BetaABPC(2,2),BetaBCAB_pw(2,2),BetaABSA_pw(1,1)]);
b23P = BetaBCAB_pw(2,1);
b24P = BetaABSA_pw(1,2);

b31P = BetaBCPC(2,1);
b32P = BetaBCAB_pw(1,2);
b33P = mean([BetaBCPC(2,2),BetaBCAB_pw(1,1),BetaBCSA_pw(1,1)]);
b34P = BetaBCSA_pw(1,2);

b41P = BetaSAPC(2,1);
b42P = BetaABSA_pw(2,1);
b43P = BetaBCSA_pw(2,1);
b44P = mean([BetaSAPC(2,2),BetaABSA_pw(2,2),BetaBCSA_pw(2,2)]);
...
% Save figure
%exportgraphics(fig1,'FigS8_MatlabFinal2.eps','Resolution',300,'ContentType','vector')
%exportgraphics(fig1,'FigS8_MatlabFinal2.tif','Resolution',300,'ContentType','vector')


% Figure S8 (not included) - Phage
fig2 = figure;
hold on
T2 = tiledlayout(4,4);
...
leg2.Layout.Tile = 16;
leg2.AutoUpdate = 'off';
leg2.PlotChildren = leg1.PlotChildren(neworder);

% Save figure
%exportgraphics(fig2,'FigS8VerPhage_MatlabFinal.eps','Resolution',300,'ContentType','vector')
%exportgraphics(fig2,'FigS8VerPhage_MatlabFinal.tif','Resolution',300,'ContentType','vector')


%% Long time predictions (Fig S9 - version not included)
...
%xticks([0,20,40,60,80].*24)
%xticklabels({'0','20','40','60','80'})
title('CRKO Polyculture','FontWeight','normal','FontSize',9)
...
%xticks([0,20,40,60,80].*24)
%xticklabels({'0','20','40','60','80'})
title('CRKO Polyculture + phage','FontWeight','normal','FontSize',9)
...
% Save figures
%exportgraphics(fig3,'FigS9VerPW_MatlabFinal.eps','Resolution',300,'ContentType','vector')
%exportgraphics(fig3,'FigS9VerPW_MatlabFinal.tif','Resolution',300,'ContentType','vector')
